<template>
  <div class="container-fluid page-body-wrapper" v-if="employe">
        ...
        <li class="nav-item nav-profile">
          <a href="#" class="nav-link">
            <div class="nav-profile-image">
              <img :src="employe.photo" alt="profile" />
              <span class="login-status online"></span>
              <!--change to offline or busy as needed-->
            </div>
            <div class="nav-profile-text d-flex flex-column">
              <span class="font-weight-bold mb-2">{{ employe.nom}} {{ employe.prenom }}</span>
...
export default{
    setup() {
        ...
        const employe = store.state.employe
